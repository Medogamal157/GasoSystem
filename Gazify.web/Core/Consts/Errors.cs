namespace Gazify.Core.Consts
{
    public class Errors
    {
        ...
        public const string DenySpicialCharacters = "Spicial characters are not allowed.";
        public const string InvalidMobileNumber = "Invalid mobile number.";
        public const string InvalidNationalId = "Invalid national ID.";
        public const string InvalidSerialNumber = "Invalid serial number.";
        public const string NotAvailableRental = "This copy/book is not available for rental.";
        public const string EmptyImage = "Please choose an image.";
        public const string BlackListedSubscriber = "This subscriber is blacklisted.";
        public const string InActiveSubscriber = "This subscriber is in active.";
        public const string MaxCopiesReached = "This subscriber has reached the max amount of rentals.";
